...
The structure of the <project/> DMP follows the Horizon 2020 ORD Pilot 
...
The <project/> RDM Copyright, License, and Waiver (CLW) Clearance Form will be used
