...
as data management and preservation questions [[1](#ref1)]. Open data is data for which
...
protecting sensitive data from inappropriate access [[2](#ref2)]. Projects starting from
...
Guidelines on FAIR Data Management in Horizon 2020 [[3](#ref3)] and is based around the
...
for creating an online DMP [[4](#ref4)]. As part of our community building and sharing
